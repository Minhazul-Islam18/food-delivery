...
if (isset($_SESSION['Login-request'])) {
  echo $_SESSION['Login-request'];
 unset ($_SESSION['Login-request']);
...
if (isset($_POST['submit'])) {
    ...
    $password = mysqli_real_escape_string($connt,$_POST['password']);

    $sqlsel = "SELECT * FROM `admin` WHERE `username` = '$username' AND `password`= '$password'";


    $res = mysqli_query($connt, $sqlsel);


    $checkpost = mysqli_num_rows($res);


    if ($checkpost == 1) {
      $_SESSION['Login'] =  "<div class='successs'>Login Success</div>";
      $_SESSION["Login-checker"] = $username;


      // echo $_SESSION['Login-checker'];
      //Redirecting
...
<head>
    ...
    <link rel="stylesheet" href="../css/locin.css">
    <title>Log In</title>
</head>
<body>
  ...
  <div class="details">
    ...
    <form action="" method="post">
      ...
      <div class="wrap">
        ...
        <div class="wrap-btn">
      <input class="sign" type="submit" name="submit" class="button" value="Sign in!">
      </div>
    </form>
  </div>
